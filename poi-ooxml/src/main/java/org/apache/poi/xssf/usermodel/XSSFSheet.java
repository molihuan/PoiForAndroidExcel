...
public class XSSFSheet extends POIXMLDocumentPart implements Sheet, OoxmlSheetExtensions {
    ...
    @Override
    public void setColumnWidthInPixels(int columnIndex, float width) {
        float widthIn256 = width * 256.0f / Units.DEFAULT_CHARACTER_WIDTH;
        setColumnWidth(columnIndex, (int) widthIn256);
    }
     ...
     *
     * @param tableArea the area that the table should cover, should not be null
